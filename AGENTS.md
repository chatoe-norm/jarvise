...
- Shipped product today is paper analytics only (no trading GUI / no order placement); day-to-day invoke paths are in `docs/product-usage.md` (CLI, VPS n8n→jobs, agent/MCP).
