...
- Deploy target is Hostinger KVM 2 ID `1269762` (`srv1269762.hstgr.cloud`, Ubuntu 24.04, 2 vCPU, 8 GB RAM, 100 GB, Malaysia). SSH user `root`. Control plane stays on Tailscale, not the public IPv4.
